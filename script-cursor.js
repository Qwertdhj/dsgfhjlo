...
$(".button-logo-whatsapp a").on("mouseenter", function () {
    cursor.addClass("activelinkWh");
    follower.addClass("activelinkWh");
});

$(".button-logo-whatsapp a").on("mouseleave", function () {
    cursor.removeClass("activelinkWh");
    follower.removeClass("activelinkWh");
});
$(".button-logo-telegram a").on("mouseenter", function () {
    cursor.addClass("activelinkTg");
    follower.addClass("activelinkTg");
});

$(".button-logo-telegram a").on("mouseleave", function () {
    cursor.removeClass("activelinkTg");
    follower.removeClass("activelinkTg");
});
